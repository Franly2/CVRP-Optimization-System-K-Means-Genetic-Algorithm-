        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.registerLinkContainer}>
              <ThemedText style={styles.registerLinkText}>Belum punya akun? </ThemedText>
              <TouchableOpacity onPress={() => router.push(`/${companySlug}/register`)}>
                <ThemedText style={[styles.registerLinkHighlight, { color: colors.primary }]}>Daftar di sini</ThemedText>
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  registerLinkText: { fontSize: 13, color: '#636E72' },
  registerLinkHighlight: { fontSize: 13, fontWeight: '700' },
